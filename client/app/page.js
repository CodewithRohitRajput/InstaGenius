  ...
  return (
    ...
    <Navbar/>
      <div className="flex flex-col min-h-screen bg-white dark:bg-black mt-14 ">
        ...
        <div className="flex justify-end mr-10 mt-4 md:-translate-y-24 -translate-x-14 md:translate-x-0 ">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="w-full h-2 bg-orange-200 dark:bg-orange-200 rounded-lg appearance-none cursor-pointer accent-orange-500"
                      />
